  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => const LiberchatWebView()),
      );
    });
  }
...
class LiberchatWebView extends StatefulWidget {
  const LiberchatWebView({super.key});
...
class _LiberchatWebViewState extends State<LiberchatWebView> {
  ...
  void initState() {
    super.initState();
    // Demande automatique de la permission micro au lancement
          ...
          ClipRRect(
            ...
            child: InAppWebView(
              initialUrlRequest: URLRequest(
                url: WebUri('https://liberchat-3-0-1.onrender.com/'),
              ),
