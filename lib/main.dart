      ...
      MaterialPageRoute(
        builder: (_) => ServerSelectionScreen(
          onServerSelected: (url) async {
            ...
            // Demander les permissions avant d'ouvrir la WebView
                  ...
                  MaterialPageRoute(
                    builder: (_) => ServerSelectionScreen(
                      onServerSelected: (url) async {
                        ...
                        // Demander les permissions avant de changer de serveur
                        await requestMediaPermissions(context);
                      },
                    ),
                  ),
          ...
          ClipRRect(
            ...
            child: InAppWebView(
              ...
              androidOnPermissionRequest: (controller, origin, resources) async {
                // Accorder les permissions micro et caméra
                if (resources.contains('android.webkit.resource.AUDIO_CAPTURE') || 
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Seules les permissions micro et caméra sont autorisées.')),
                  );
                  return PermissionRequestResponse(
                    resources: resources,
