...
### 🆕 Nouveautés v3.5.1+
- 🎥 Support complet de la vidéo en direct (caméra + microphone)
- 💾 Historique intelligent des 5 derniers serveurs utilisés
- 🔧 Permissions optimisées pour les appels vidéo
...
- 🎥 **Support vidéo en direct** - Permissions caméra et microphone
- 💾 **Historique des serveurs** - Sauvegarde des 5 derniers serveurs utilisés
...
- `permission_handler` - Gestion des permissions (caméra, microphone)
- `socket_io_client` - Communication temps réel
- `encrypt` - Chiffrement
- `shared_preferences` - Stockage local et historique serveurs
...
- ✅ **Permissions transparentes** - Caméra et microphone pour vidéo uniquement
